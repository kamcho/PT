...
from SubjectList.views import AskAi, CreateCourse, Learning, ManageCourse, ManageSubTopic, ManageSubject, ManageTopic, Tests, MediaSelect, Read, Assignment, Finish, AssignmentDetail, Syllabus, Messages, MyProgress, \
    ContactUs
from .import views
urlpatterns = [

...
urlpatterns = [
    ...
    path('Tests/', TestsView.as_view(), name='teacher-tests-view'),
    ...
    path('<str:class>/<str:id>/Create-Test/', InitialiseCreateTest.as_view(), name='initialise-test'),
    ...
    path('remove-quiz-from-session/', views.remove_quiz_from_session, name='remove-quiz-from-session'),
